  ...
  const products = [
    {
      ...
      description:
        "The main page of the NIntendoCardDelivery store was elaborated, adding the cards and design of the whole page, showing it in a pleasant way for the user.",
      description2: "",
      description3: "",
    ...
    },
    {
      ...
      description:
        "Kiosk where you can navigate between different products, brands, product categories with promotions and featured products, as well as a shopping cart to create orders, a new view was implemented for the stores where the user can see all the products offered by the different stores specified by their categories.",
      description2:
        "Management of kiosks and the products displayed in them for cannabis products stores, we implemented the integration of a new product where you can make purchases with new products.",
      description3:
        "We introduced the logic to create the orders, store them in the database and be able to create all the necessary responses and send them to the different endpoints for implementation.",
    ...
    },
    {
      ...
      description:
        "BioRaices is a project where users can view the different products, add them to the cart and make their purchases through a payment gateway.",
      description2: "",
      description3: "",
    ...
    },
    {
      ...
      description:
        "Project task management where the user can keep track of the time it will take to do these tasks, you can also create teams where each team will be assigned several projects, each project may have collaborators where they can have access to these projects and modify their status, there will also be a chat room where users can send messages to their collaborators.",
      description2: "",
      description3: "",
      imagesCart: [
        images.natab,
    ...
    },
    {
      ...
      description:
        "Web App that quotes the price of different types of cryptocurrencies and returns the updated price along with their prices and the lowest of the day.",
      description2: "",
      description3: "",
      imagesCart: [
        images.cripto,
    ...
    },
    {
      ...
      description:
        "Web App that allows us to search information about the different drinks that are normally served in restaurants, bars, etc.., you can see their name, instructions, ingredients and quantity of ingredients so you can make them too.",
      description2: "",
      description3: "",
